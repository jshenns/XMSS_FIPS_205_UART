...
HD_PWD='C:/Users/joshe/Documents/XMSS_FIPS_205_UART/xmss_fips_205_UART_vivado_project/xmss_fips_205_UART_vivado_project.runs/my_bram_xmss_node_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_bram_xmss_node_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_bram_xmss_node_2.tcl
