...
HD_PWD='C:/Users/joshe/Documents/XMSS_FIPS_205_UART/xmss_fips_205_UART_vivado_project/xmss_fips_205_UART_vivado_project.runs/sig_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sig_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sig_fifo.tcl
