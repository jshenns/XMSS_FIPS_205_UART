...
REM
REM Generated by Vivado on Wed Oct 08 12:27:46 -0500 2025
...
echo "xvlog --incr --relax -prj fft_freq_tb_vlog.prj"
call xvlog  --incr --relax -prj fft_freq_tb_vlog.prj -log xvlog.log
